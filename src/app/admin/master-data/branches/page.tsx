  ...
  const fetchData = async (
    ...
    try {
      ...
      if (response.ok) {
        ...
        message.error("Gagal mengambil data branches");
      }
    } catch {
    ...
    },
    {
      ...
      render: (_: unknown, record: Branch) => (
        <Space>
          ...
          <Popconfirm
            title="Hapus Branch"
            description="Apakah Anda yakin ingin menghapus branch ini?"
  ...
  return (
    <AdminLayout>
      <div className="space-y-6">
        ...
        <Modal
          title={editingItem ? "Edit Branch" : "Tambah Branch"}
          open={isModalOpen}
        ...
        >
          <Form form={form} layout="vertical" onFinish={handleSubmit}>
            <Form.Item
              ...
              label="Nama Branch"
              rules={[
                { required: true, message: "Nama branch harus diisi!" },
                { min: 2, message: "Nama branch minimal 2 karakter!" },
              ]}
            >
              <Input placeholder="Masukkan nama branch" />
            </Form.Item>
            ...
            <Form.Item
              ...
              label="Kode Branch"
              rules={[
                { required: true, message: "Kode branch harus diisi!" },
                { min: 3, message: "Kode branch minimal 3 karakter!" },
              ]}
            >
              <Input placeholder="Masukkan kode branch (contoh: SMA-YMH-APT)" />
            </Form.Item>
